/**
 * ClinicBridge AI Tech Widget v2.0
...
(function (w, d) {
  ...
  function inject() {
    ...
    // Panel
    root.innerHTML += `
      <div id="cbw-panel" role="dialog" aria-label="ClinicBridge AI Tech Assistant" aria-hidden="true">
        <div id="cbw-head">
          <div class="cbw-hleft">
            <div class="cbw-avatar">${AVATAR_SVG}</div>
            <div>
              <span class="cbw-hname">ClinicBridge AI Tech Assistant</span>
      ...
      <button id="cbw-launcher" aria-label="Open ClinicBridge AI Tech Assistant">
        ${ICON_SVG}
