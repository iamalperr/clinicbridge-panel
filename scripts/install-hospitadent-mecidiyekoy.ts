...
const SOURCE_URL = "https://feelinhealthy.com/medicalcenter/hospitadent-dental-group-mecidiyekoy";

const CLINIC_DATA = {
  clinicId: "hospitadent-dental-group-mecidiyekoy",
  clinicName: "Hospitadent Dental Group Mecidiyeköy",
  clinicSlug: "hospitadent-dental-group-mecidiyekoy",
  internalKey: "hospitadent_dental_group_mecidiyekoy",
  ...
  subTreatments: [
    "Dental Implants", "Zirconium Crowns", "Digital Smile Design", "Dental SPA Treatments",
    "Laminate Veneers", "Box Technique", "Bonding Applications", "Teeth Whitening"
  ],
  priority: 85,
  ...
  metadata: {
    openedYear: 2011,
    indoorAreaSqm: 3000,
    treatmentUnitCount: 21,
    operatingRoomCount: 1
  },
  overview: {
    shortDescription: "Hospitadent Dental Group Mecidiyeköy is a top-tier dental clinic established in 2011 in Istanbul. Spanning 3,000 m², it houses 21 modern dental units and 1 operating room.",
    longDescription: "Established in 2011, Dental Group Hospitadent Mecidiyeköy Dental Hospital is a top-tier dental clinic in Istanbul, Turkey. Located on a spacious 3,000 m² area, the hospital houses 21 modern dental units and 1 fully equipped operating room, providing exceptional care in a comfortable, hygienic setting. As one of the best dental clinics in Istanbul, we offer a wide range of oral and dental health services including Dental Implants, Zirconium Crowns, Digital Smile Design, Dental SPA Treatments, Laminate Veneers, Box Technique, Bonding Applications, and Teeth Whitening.\n\nTo ensure a comfortable experience for international patients, we offer multilingual support in English, German, French, Arabic, Russian, and Bulgarian. We provide complimentary services like free panoramic X-rays, dental tomography, and free VIP airport transfer. The clinic is easily accessible from both Istanbul Airport and the 15 July Martyrs Bridge.\n\nClinic Hours:\nMonday to Saturday: 08:00 – 19:00\nSunday: Closed",
    targetPatientProfile: "Domestic and international patients seeking high-quality dental treatments in a central Istanbul location. Kesin tedavi planı, klinik değerlendirme sonrasında belirlenir.",
...
const TREATMENTS_AND_PRICES = [
  ...
  { name: "Composite Veneers", price: 130, currency: "EUR", duration: "1 Day", type: "source_average" },
...
const DOCTORS = [
  { fullName: "Ebru Hattatoğlu", specialty: "", experience: "23 Years", education: "It has not been added yet.", languages: ["Turkish", "English"], biography: "Associations: It has not been added yet.", sourceUrl: SOURCE_URL },
  { fullName: "İsmail Eser Bolat", specialty: "", experience: "12 Years", education: "It has not been added yet.", languages: ["Turkish", "English"], biography: "Associations: It has not been added yet.", sourceUrl: SOURCE_URL },
  { fullName: "Berk Aksoy", specialty: "", experience: "5 Years", education: "It has not been added yet.", languages: ["Turkish", "English"], biography: "Associations: It has not been added yet.", sourceUrl: SOURCE_URL },
  { fullName: "Yiğit Emrah Kurt", specialty: "", experience: "Not Provided", education: "Istanbul University Faculty of Dentistry", languages: ["Turkish", "English"], biography: "Associations: Nisantasi University / Social Sciences Institute / Health Management Master Diploma, Nobel Biocare DTX Sutidio Implant and Nobel Guide Concept / Dr. Powel Jastrzebski / 2019.", sourceUrl: SOURCE_URL }
];

const KB_DOCS = [
  { knowledgeType: "clinic_overview", title: "Hospitadent Mecidiyeköy Overview", content: "Established in 2011, Dental Group Hospitadent Mecidiyeköy Dental Hospital is a top-tier dental clinic located in Istanbul (Şişli / Fulya area).", locale: "en", translationStatus: "verified_from_source" },
  { knowledgeType: "clinic_capacity", title: "Clinic Capacity", content: "Spanning 3,000 m², the hospital houses 21 modern dental units and 1 fully equipped operating room.", locale: "en", translationStatus: "verified_from_source" },
  { knowledgeType: "dental_services", title: "Dental Services", content: "Offers comprehensive oral and dental health services including Dental Implants, Zirconium Crowns, Digital Smile Design, Dental SPA Treatments, Laminate Veneers, Box Technique, Bonding Applications, and Teeth Whitening.", locale: "en", translationStatus: "verified_from_source" },
  ...
  { knowledgeType: "consultations", title: "Consultations", content: "Offers free Dentist Consultation and free Implant Dentist Consultation.", locale: "en", translationStatus: "verified_from_source" },
  ...
  { knowledgeType: "transfer_services", title: "Transfer Services", content: "Complimentary VIP airport transfer is stated in the profile. Easily accessible from both Istanbul Airport and the 15 July Martyrs Bridge.", locale: "en", translationStatus: "verified_from_source" },
...
async function main() {
  ...
  const duplicateSearchSlugs = [
    ...
    "hospitadent_dental_group_mecidiyekoy"
  ];
