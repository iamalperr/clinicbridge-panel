...
(function (w, d) {
  ...
  var SYS = {
    tr: {
      ...
      consentText: 'Yapay zekâ asistanımızla yapacağınız görüşmelerde paylaştığınız bilgiler hizmet kalitesi amacıyla işlenebilir. Devam ederek {LINK}’ni okuduğunuzu ve kabul ettiğinizi onaylamış olursunuz.',
    ...
    en: {
      ...
      consentText: 'Information you share with our AI assistant may be processed to improve service quality. By continuing, you acknowledge that you have read and accepted the {LINK}.',
    ...
    wrapper.innerHTML = [
      '<div id="cbw-panel" role="dialog" aria-hidden="true">',
        ...
        '<div id="cbw-consent" style="display:none;flex-direction:column;flex:1;padding:24px;text-align:center;align-items:center;justify-content:center;background:#fff;z-index:10;">',
          '<svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="' + s.primaryColor + '" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" style="margin-bottom:16px;opacity:0.9;">',
