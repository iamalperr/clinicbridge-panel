    ...
    try {
      const leadRes = await fetch(`/api/public/agency/${SLUG}/lead`, {
        ...
        body: JSON.stringify({
          ...
          language: lang,
          treatmentCategory:
            getAgencyTreatmentContext(ctx).category || matchedCategory || "other",
      ...
      const quoteRes = await fetch(`/api/public/agency/${SLUG}/quote`, {
        ...
        body: JSON.stringify({
          ...
          treatmentCategory:
            getAgencyTreatmentContext(ctx).category || matchedCategory || "other",
          treatmentName:
            getAgencyTreatmentContext(ctx).category || matchedCategory || "",
          subTreatment: getAgencyTreatmentContext(ctx).subcategory || "",
    ...
    try {
      const leadRes = await fetch(`${base}/lead`, {
        ...
        body: JSON.stringify({
          ...
          treatmentCategory:
            matchedCategory || getAgencyTreatmentContext(sessionCtx).category || "other",
