...
const tr = {
  ...
  hero: {
    ...
    subtitle: "ClinicBridge AI Tech, kliniğinizin web sitesine entegre edilen yapay zekâ destekli asistan ile hasta sorularını anında yanıtlar, hizmetlerinizi açıklar ve randevu taleplerini doğru şekilde yönlendirir.",
  ...
  solution: {
    title: "ClinicBridge AI Tech Bu Süreci Otomatikleştirir",
  ...
  journey: {
    ...
    subtitle: "ClinicBridge AI Tech, kliniğinizin tonu, hizmetleri ve hasta karşılama yaklaşımına göre eğitilir. Böylece ziyaretçiler standart bir chatbot ile değil, kliniğinize özel dijital hasta asistanı ile iletişim kurar.",
    steps: [
  ...
  clinicTypes: {
    ...
    subtitle: "ClinicBridge AI Tech; diş, estetik, saç ekimi, psikoloji, dermatoloji ve sağlık turizmi odaklı kliniklerde hasta sorularını yanıtlamak ve randevu taleplerini yönlendirmek için kullanılabilir.",
    cards: [
  ...
  demo: {
    title: "ClinicBridge AI Tech'ı Kliniğinizde Deneyin",
  ...
  footer: {
    brand: "ClinicBridge AI Tech", tagline: "Yapay zekâ destekli klinik asistanı",
...
const en = {
  ...
  hero: {
    ...
    subtitle: "ClinicBridge AI Tech helps clinics answer patient questions instantly, explain treatments clearly, and guide visitors toward appointments through an AI-powered assistant integrated into your website.",
  ...
  solution: {
    title: "ClinicBridge AI Tech Automates This Entire Process",
  ...
  journey: {
    ...
    subtitle: "ClinicBridge AI Tech is trained on your clinic's tone, services, and patient welcome approach — so visitors interact with a dedicated digital patient assistant, not a generic chatbot.",
    steps: [
  ...
  clinicTypes: {
    ...
    subtitle: "ClinicBridge AI Tech can be used by dental, aesthetic, hair transplant, dermatology, psychology, and medical tourism clinics to answer patient questions and guide appointment requests.",
    cards: [
  ...
  demo: {
    title: "Try ClinicBridge AI Tech for Your Clinic",
  ...
  footer: {
    brand: "ClinicBridge AI Tech", tagline: "AI-powered clinic assistant",
