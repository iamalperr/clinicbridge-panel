...
export default function AuthGuard({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    if (!loading) {
      const PUBLIC_ROUTES = ["/", "/login", "/privacy", "/terms", "/kvkk", "/landing", "/reset-password", "/showcase-demo", "/showcase-patient-questions", "/linkedin-assets", "/social-posts", "/instagram-post", "/promo-video", "/reels-cover"];
